      ...
      <section class="main">
        <div class="container main__container">
          <div class="pomodoro-form window">
            ...
            <div class="window__body">
              ...
              <div class="window__buttons">
                ...
                <button class="button button-secondary hidden">Стоп</button>
              </div>
            </div>
          ...
          <div class="pomodoro-tasks">
            <div class="tasks">
              <p class="tasks__title">Задачи:</p>
              <ul class="tasks__list">
                <li class="tasks__item important">
                  <span class="count-number">1</span>
                  <button class="tasks__text tasks__text_active">Сверстать сайт</button>
                  <button class="tasks__button"></button>
                  <!-- popup menu -->
                  <div class="popup popup_active">
                    <button class="popup__button popup__edit-button">Редактировать</button>
                    <button class="popup__button popup__delete-button">Удалить</button>
                  </div>
                </li>
                <li class="tasks__item so-so">
                  <span class="count-number">1</span>
                  <button class="tasks__text">Оплатить налоги</button>
                  <button class="tasks__button"></button>
                  <!-- popup menu -->
                </li>
                <li class="tasks__item default">
                  <span class="count-number">3</span>
                  <button class="tasks__text">Проверить валидность</button>
                  <button class="tasks__button"></button>
                </li>
              </ul>
              <p class="tasks__deadline">1&nbsp;час 30&nbsp;мин</p>
            </div>
            <div class="manual">
              <details class="manual__details">
                <summary class="manual__title tasks__header-title">Инструкция</summary>
                <ol class="manual__list">
                  <li class="manual__item">Напишите название задачи чтобы её&nbsp;добавить</li>
                  <li class="manual__item">
                    Для активации задачи, выберите её&nbsp;из&nbsp;списка
                  </li>
                  <li class="manual__item">Запустите таймер</li>
                  <li class="manual__item">Работайте пока таймер не&nbsp;прозвонит</li>
                  <li class="manual__item">Сделайте короткий перерыв (5&nbsp;минут)</li>
                  <li class="manual__item">
